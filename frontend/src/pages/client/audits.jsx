...
import { RiCheckboxCircleLine, RiCheckLine, RiEyeFill, RiFilePdf2Fill } from 'react-icons/ri';
	...
	const ActionButtons = ({ id }) => {
		...
		return (
			<div className='flex gap-x-4'>
				...
				<Link href={`/audit/${id}/report`} target='_blank' className={`${style}`}>
					<RiFilePdf2Fill /> <span className='px-1 text-xs'>Report</span>
				</Link>
			</div>
		);
	};
